...
public class SeanceController {
    ...
    // >>> NEW: service absences
    private final AbsenceService absenceService;

    public SeanceController(SeanceService seanceService, AbsenceService absenceService) {
    ...
    /**
     * Liste des absences d'une séance (pour la modale de marquage).
     */
//    @GetMapping("/{id}/absences")
//    public ResponseEntity<List<AbsenceResponseDTO>> getAbsences(@PathVariable Long id) {
//        return ResponseEntity.ok(absenceService.listBySeance(id));
//    }
//
//    /**
//     * Compteur simple pour badge "Abs: n".
//     */
//    @GetMapping("/{id}/absences/count")
//    public ResponseEntity<Long> getAbsencesCount(@PathVariable Long id) {
//        return ResponseEntity.ok(absenceService.countBySeance(id));
//    }
//
//    /**
//     * Enregistre en masse l'état des absences pour la séance :
//     * - les étudiants listés dans le payload = ABSENTS (avec justif/motif)
//     * - les autres = PRÉSENTS
//     */
//    @PostMapping("/{id}/absences/bulk")
//    @SecurityRequirement(name = "bearerAuth")
//    @PreAuthorize("hasAnyRole('ADMIN','PROFESSEUR')")
//    public ResponseEntity<Void> saveAbsences(
//            @PathVariable Long id,
//            @Valid @RequestBody List<AbsenceDTO> list
//    ) {
//        absenceService.saveBulk(id, list);
